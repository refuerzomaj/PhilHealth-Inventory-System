			...
			<div class="modal-body">
				<!-- main form -->
					...
					<input type="hidden" id="iID">
					  ...
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="om_amount-update">OM Quantity:</label>
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="om_amount-update" placeholder="Enter OM Quantity">
					    </div>
					  </div>
					  
					  <div class="form-group">
					    <label class="control-label col-sm-3" for="ismd_amount-update">ISMD Quantity:</label>
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="ismd_amount-update" placeholder="Enter OM Quantity">
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3" for="itrmd_amount-update">ITRMD Quantity:</label>
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="itrmd_amount-update" placeholder="Enter OM Quantity">
					    </div>
					  </div>

					  <div class="form-group">
					    <label class="control-label col-sm-3" for="ippsd_amount-update">IPPSD Quantity:</label>
					    <div class="col-sm-9"> 
					      <input type="number" step="any"  class="form-control" id="ippsd_amount-update" placeholder="Enter OM Quantity">
					    </div>
					  </div>		
